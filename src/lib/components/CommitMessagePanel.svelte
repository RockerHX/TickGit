...
>
  ...
  <div
    class="max-h-36 overflow-y-auto whitespace-pre-wrap break-words rounded-xl border border-white/10 bg-[#18202d]/80 px-3 py-2.5 font-mono text-[12px] leading-5 text-slate-300"
  >
    {#if message}
      {message}
    {:else}
